...
| Sample rate | **44100 Hz** (tylko, nie 48000!) |
| Kanały | 2 (stereo) |
...
Log z inicjalizacji: `/tmp/tonex_udev_init.log`
...
# ToneX USB Audio — Linux Setup (English)
...
| Sample rate | **44100 Hz only** (not 48000!) |
| Channels | 2 (stereo) |
| CDC baud rate | 115200, 8N1 |
...
Initialization log: `/tmp/tonex_udev_init.log`
